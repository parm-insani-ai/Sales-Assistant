...
| **🎯 Prospecting engine** | The lead-generation core. **Follow-up cadences**: every new lead auto-gets a proven multi-touch reminder sequence (call/text over 30 days) so none go cold. **Daily call list**: mines your contacts for buying signals — due follow-ups, cold leads (no contact in 7+ days), past-customer equity/anniversaries, birthdays, lease-ends — into a prioritized "who to call today." **Activity scoreboard**: daily touch goal + appointments-set, so you work the leading indicators that drive sales. Editable cadence and goal in Settings. |
