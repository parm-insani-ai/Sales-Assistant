...
if (landing.greeting !== "Admin" || landing.tabs.join() !== "Home,Appts,Insights,Team,Settings" || landing.voice || landing.plus !== "none") fail("the admin account didn't get the store's app: " + JSON.stringify(landing));
