...
const ROWS = [
  ...
  { key: "blindspot", label: "Blind-spot monitor", get: (v) => v.blindSpot || "—" },
  { key: "rearaeb", label: "Rear auto braking", get: (v) => v.rearAeb || "—" },
  { key: "cam360", label: "360° camera", get: (v) => v.cam360 || "—" },
  { key: "airbags", label: "Airbags", best: "high", num: (v) => Number(v.airbags) || null, get: (v) => v.airbags || "—" },
  { key: "rating", label: "Safety rating (IIHS)", get: (v) => v.safetyRating || "—" },
